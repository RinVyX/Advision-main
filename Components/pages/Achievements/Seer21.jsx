...
const Seer21 = ({ subPage }) => {
  return (
    <Content
      className={`w-full  absolute ${
        subPage === "seer21" ? "left-0" : "left-[-200%]"
    ...
    >
      <GrayText>
        Because the challenges of Seer21 marketing are our raison d'être!
      </GrayText>
      <ContentText>
      ...
      <Heading>Our Seer21 marketing agency can help you:</Heading>
      <List>
