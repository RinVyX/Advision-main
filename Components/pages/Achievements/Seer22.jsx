...
const Seer22 = ({ subPage }) => {
  return (
    <Content
      className={`w-full  absolute ${
        subPage === "seer22" ? "left-0" : "left-[-200%]"
    ...
    >
      <GrayText>
        Because the challenges of Seer22 marketing are our raison d'être!
      </GrayText>
      <ContentText>
      ...
      <Heading>Our Seer22 marketing agency can help you:</Heading>
      <List>
