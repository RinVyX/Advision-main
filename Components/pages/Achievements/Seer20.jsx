...
const Seer20 = ({ subPage }) => {
  return (
    <Content
      className={`w-full  absolute ${
        subPage === "seer20" ? "left-0" : "left-[-200%]"
    ...
    >
      <GrayText>
        Because the challenges of Seer20 marketing are our raison d'être!
      </GrayText>
      <ContentText>
      ...
      <Heading>Our Seer20 marketing agency can help you:</Heading>
      <List>
