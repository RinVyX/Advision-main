  ...
  return (
    ...
    <div className="grid grid-cols-12 h-full">
      <div className="col-start-2 col-end-12 flex items-center justify-center">
        <div id="p1" className={`xl:text-[70px] lg:text-[60px] md:text-[50px] text-[30px] max-md:-mt-[50%] text-center drop-shadow-[0_3px_3px_rgba(0,0,0,0.25)] 
        ...
        <div id="p2" className={`xl:text-[40px] lg:text-[35px] md:text-[30px] text-[17px] max-md:-mt-[50%] inline text-center drop-shadow-[0_3px_3px_rgba(0,0,0,0.25)] 
                                ${subPage === 'philosophy' ? 'fade-transition active' : 'fade-transition'}`} 
                     style={{ display: 'none' }}>
        ...
        <div id="p3" className={`xl:text-[40px] lg:text-[35px] md:text-[30px] text-[15px] max-md:-mt-[50%] inline text-center drop-shadow-[0_3px_3px_rgba(0,0,0,0.25)] 
                                 ${subPage === 'philosophy' ? 'fade-transition active' : 'fade-transition'}`} 
                     style={{ display: 'none' }}>
        ...
        <div id="p4" className={`xl:text-[40px] lg:text-[35px] md:text-[30px] text-[15px] max-md:-mt-[50%] inline text-center drop-shadow-[0_3px_3px_rgba(0,0,0,0.25)] 
                              ${subPage === 'philosophy' ? 'fade-transition active' : 'fade-transition'}`} 
                     style={{ display: 'none' }}>
