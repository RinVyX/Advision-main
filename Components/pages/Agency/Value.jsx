...
return (
  ...
  >
    ...
    <div className="grid grid-cols-12 h-full">
      ...
      <div id="va1" className={`xl:text-[70px] lg:text-[60px] md:text-[50px] text-[30px] -mt-[50%] text-center drop-shadow-[0_3px_3px_rgba(0,0,0,0.25)] 
        ...
        <div id="va2" className={`xl:text-[40px] lg:text-[35px] md:text-[30px] text-[15px] -mt-[50%] inline text-center drop-shadow-[0_3px_3px_rgba(0,0,0,0.25)] 
                                ${subPage === 'value' ? 'fade-transition active' : 'fade-transition'}`} 
                      style={{ display: 'none' }}>
        ...
        <div id="va3" className={`xl:text-[40px] lg:text-[35px] md:text-[30px] text-[15px] -mt-[50%] inline text-center drop-shadow-[0_3px_3px_rgba(0,0,0,0.25)] 
                                ${subPage === 'value' ? 'fade-transition active' : 'fade-transition'}`} 
                      style={{ display: 'none' }}>
            <span>Through </span>
