  ...
  return (
    ...
    >
      <div className="container mx-auto text-justify p-8">
        ...
        <div >
          <div className="underline underline-offset-1">Logo Design:</div>
          ...
          <div className="underline underline-offset-1">Brand Identity:</div>
          ...
          <div className="underline underline-offset-1">Print Design:</div>
          ...
          <div className="underline underline-offset-1">Digital Design:</div>
          ...
          <div className="underline underline-offset-1">Illustration and Infographics:</div>
          ...
          <div className="underline underline-offset-1">Photo Editing and Retouching:</div>
          ...
          <div className="underline underline-offset-1">Packaging Design:</div>
          ...
          <div className="underline underline-offset-1">Motion Graphics and Animation:</div>
          ...
          <div className="underline underline-offset-1">User Interface (UI) Design:</div>
