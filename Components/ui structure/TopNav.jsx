...
const TopNav = () => {
  ...
  return (
    <nav className="top-0 absolute left-0 w-full h-[80px] dark:bg-black flex justify-between items-center border-gray-400 dark:border-gray-100 dark:text-white text-black">
      {/* logo */}
      <div
